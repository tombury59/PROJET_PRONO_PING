        ...
        <div class="mx-auto space-y-4 sm:px-6 lg:px-8">
            <div class="overflow-hidden rounded-lg bg-white shadow-sm dark:bg-neutral-900">
                @forelse ($notifications as $notification)
                    <div class="group flex items-center border-b border-neutral-100 last:border-0 hover:bg-neutral-50 dark:border-neutral-800 dark:hover:bg-white/5">
                        <a
                        ...
                        <form method="POST" action="{{ route('notifications.destroy', $notification->id) }}" class="pr-4">
                            ...
                            <button
                                type="submit"
                                class="rounded p-1.5 text-neutral-300 hover:text-red-600 group-hover:text-neutral-400 dark:hover:text-red-400"
                                title="Supprimer"
                            >
