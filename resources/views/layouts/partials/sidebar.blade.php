            ...
            <div class="mt-4 border-t border-neutral-200 pt-4 dark:border-neutral-800">
                ...
                <div class="space-y-1 mt-1">
                    ...
                    <x-sidebar-link route="admin.users.index" active-pattern="admin.users.*" label="Utilisateurs">
                        <svg class="size-5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-5.13a4 4 0 11-8 0 4 4 0 018 0zm6 3a4 4 0 10-8 0" />
                        </svg>
                    </x-sidebar-link>
                </div>
            </div>
